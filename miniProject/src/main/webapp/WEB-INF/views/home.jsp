...
<body id="page-top">
	...
	<img class="z-0 position-absolute" style="width: 100%; filter: brightness(40%)" src="assets/img/main-bg.jpg">
				...
				<div class="container">
					<div class="row">
						<div class="col-6 mx-auto my-auto">
							<div class="mb-3">탄소 배출량 및 권장 배출량을 예측하고 건축 시 예상되는 탄소 배출량과 건물 내 에너지 사용량을 바탕으로 예상 탄소배출량을 확인 하여 계산한 결과를 바탕으로 탄소배출량 저감을 유도 합니다.</div>
							<div>사용 전력량을 통해 예상 탄소 배출량을 계산합니다. 건물의 면적에 따른 평균 탄소 배출량과 비교하여 탄소배출량 저감을 유도 합니다.</div>
						</div>
					</div>
