...
<body id="page-top">
	...
	<section class="page-section" id="contact">
		...
		<div class="container pt-5">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-3">질문
				등록하기</h2>
				...
				<div class="col-lg-8 col-xl-7">
					<c:if test="${sessionScope.login.userId != admin}">
						<form id="boardWriteForm"
							...
							<div class="mb-3">
								<input class="form-control" type="text" name="quTitle"
									id="title" placeholder="제목을 입력해주세요" />
							</div>

							<div class="mb-3">
								<textarea id="smartEditor" class="form-control" rows="10"
									name="quContent"></textarea>
							</div>

							<div class="d-flex justify-content-end">
								<a class="btn btn-secondary me-2"
									href="${pageContext.request.contextPath }/boardView">취소</a>
