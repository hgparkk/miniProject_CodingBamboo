...
<body id="page-top">
	...
	<section class="page-section" id="contact">
		...
		<div class="container pt-5">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-3">공지사항 수정</h2>
			<!-- Contact Section Form-->
			<div class="row justify-content-center">
		 		<div class="col-lg-8 col-xl-7">
					
					<form id="noticeWriteForm" action="${pageContext.request.contextPath }/noticeEditDo" method="POST">
						<input type="hidden" name="noNo" value="${keyNotice.noNo }">
					
						<div class="mb-3">
							<input class="form-control" type="text" name="noTitle" value="${keyNotice.noTitle }"/>					
						</div>
						
						<div class="mb-3">
							<textarea id="smartEditor" class="form-control" rows="10" name="noContent">${keyNotice.noContent }</textarea>					
						</div>
						
						<div class="d-flex justify-content-end">
							<a class="btn btn-secondary me-2" href="${pageContext.request.contextPath }/noticeDetailView?no=${keyNotice.noNo}">취소</a>
